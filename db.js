...
const SEED_WORDS = [
  ...
  { en: "Thank you", bm: "Natotela", cat: "Common Phrases", pos: "interjection", pron: "na-TO-te-la", ex: "Natotela sana!", syn: ["Twatotela"], ant: [], contrib: "Admin" },
  { en: "I love you", bm: "Nakutemenwa", cat: "Common Phrases", pos: "phrase", pron: "na-ku-TE-me-nwa", ex: "Nakutemenwa, umukwai.", syn: [], ant: [], contrib: "Admin" },
  { en: "Welcome", bm: "Mwapokelelwa", cat: "Greetings", pos: "interjection", pron: "mwa-po-ke-LEL-wa", ex: "Mwapokelelwa ku Zambia!", syn: [], ant: [], contrib: "Joseph B" },
  ...
  { en: "God", bm: "Lesa", cat: "Church", pos: "noun", pron: "LE-sa", ex: "Lesa alelefya.", syn: [], ant: [], contrib: "Admin" },
  ...
  { en: "Money", bm: "Impiya", cat: "Business", pos: "noun", pron: "IM-pi-ya", ex: "Nalikwata impiya yambula.", syn: [], ant: [], contrib: "Admin" },
...
const SEED_USERS = [
  { name: "Joseph Bubenshi", email: "admin@bembahub.com", pass: "admin123", role: "admin", pts: 350, initials: "JB", color: "#4A1299" },
  { name: "Mary Mutale", email: "mod@bembahub.com", pass: "mod123", role: "moderator", pts: 180, initials: "MM", color: "#1251A3" },
  { name: "Peter Chanda", email: "trans@bembahub.com", pass: "trans123", role: "translator", pts: 120, initials: "PC", color: "#1E5C20" },
  { name: "Gift Mwansa", email: "gift@bembahub.com", pass: "gift123", role: "translator", pts: 95, initials: "GM", color: "#7C3A12" },
  { name: "Grace Tembo", email: "grace@bembahub.com", pass: "grace123", role: "visitor", pts: 12, initials: "GT", color: "#616161" },
  { name: "Guest", email: "guest@bembahub.com", pass: null, role: "visitor", pts: 0, initials: "G", color: "#9E9E9E" },
];
...
export async function listUsers() {
  const { rows } = await pool.query("SELECT * FROM users ORDER BY pts DESC");
  return rows;
}
...
export async function analyticsSummary() {
  ...
  const { rows: topContributors } = await pool.query("SELECT name, pts, role FROM users ORDER BY pts DESC LIMIT 5");
  return {
